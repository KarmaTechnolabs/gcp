 ...
 */
class GCPImageLoader private constructor(
        val url: String? = null,
        val uri: Uri? = null,
    ...
    companion object Request {
        ...
        @JvmStatic
        fun load(url: String?) = GCPImageLoader(url)

        @JvmStatic
        fun load(uri: Uri?) = GCPImageLoader(uri = uri)

        @JvmStatic
        fun loadGif(resourceId: Int) = GCPImageLoader(gifDrawableResource = resourceId)
    }
}
