 ...
 */
class AllPharmaImageLoader private constructor(
        val url: String? = null,
        val uri: Uri? = null,
    ...
    companion object Request {
        ...
        @JvmStatic
        fun load(url: String?) = AllPharmaImageLoader(url)

        @JvmStatic
        fun load(uri: Uri?) = AllPharmaImageLoader(uri = uri)

        @JvmStatic
        fun loadGif(resourceId: Int) = AllPharmaImageLoader(gifDrawableResource = resourceId)
    }
}
